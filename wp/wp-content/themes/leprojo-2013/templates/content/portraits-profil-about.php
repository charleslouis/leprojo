...
<ul class="unstyled team">
	<li class="team-member">
		<figure>
			<img src="<?php the_field('photo1'); ?>" alt="Arthur Allizard">
		</figure>
	...
	<li>
		...
		<span>Charles-Louis Allizard,</br><em>Cofondateur & webdesigner</em></span></br>
		<a href="https://twitter.com/Charleloui" target="_blank">@Charleloui</a>
	</li>
</ul>