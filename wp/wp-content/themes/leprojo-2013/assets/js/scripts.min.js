...
function basementFitText(a) {
    if (document.getElementById(a)) {
        var b = $("#" + a);
        newWidth = b.data("proportion"), b.css("width", newWidth), $.getScript(jsFolder + "vendor/jquery.fittext.min.js", function() {
            $("#" + a).fitText(1, {
                minFontSize: "28px"
            });
        });
...
(function(a) {
    a("document").ready(function() {
        removePhoneHref(".phone-link"), removePhoneHref(".skype-link"), basementFitText("headline");
    });
})(jQuery);