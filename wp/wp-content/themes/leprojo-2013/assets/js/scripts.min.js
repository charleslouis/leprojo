/*! lasourisetlepiano-2013 - v1.0.0 - 2014-01-16
...
function socialSharer() {
    document.getElementById("sharer-inner-wrapper") && ($("#sharer-inner-wrapper").hide(), 
    $("#sharer-block-container").toggleClass("active unactive"), $("#dislay-sharer-wrapper").click(function() {
        ...
        $("#sharer-inner-wrapper").slideToggle(), $("#sharer-block-container").toggleClass("active unactive");
    }));
}
...
(function(a) {
    a("document").ready(function() {
        ...
        basementFitText("scrolldown span", 1, "28px"), socialSharer();
    });
})(jQuery);