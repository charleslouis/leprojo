/*! lasourisetlepiano-2013 - v1.0.0 - 2013-10-03
...
(function(a, b, c) {
...
}(Foundation.zj, this, this.document), function(a) {
    function b(b) {
    ...
    var c = a("script[src*=scripts]").attr("src");
    c.replace("js/scripts.min.js", "img/"), a("document").ready(function() {
        b(".phone-link"), b(".skype-link");
    });
}(jQuery);