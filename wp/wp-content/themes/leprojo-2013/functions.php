...
// include_once('advanced-custom-fields/acf.php');          	// Custom functions
// require_once locate_template('/acf.php');          				// Custom functions
...
require_once('lib/scripts.php'); // enqueue scripts
